...
define(['jquery', 'underscore', 'backbone'
        ...
        , 'text!templates/Setting/school/view.html'
        , 'text!templates/Setting/school/list.html'
        , 'view/Setting/school/Add'
        , 'view/Setting/school/Edit'
    ],
    function ($, _, Backbone
        , PageView
        , View
        ...
        SchoolView = Backbone.View.extend({
            ...
            queryDate: function(){
                ...
                userModel.fetchEx(pageOpt,{
                    url : 'api/school/querySchoolPage',
            ...
            delete: function(e){
                ...
                var userModel = new Backbone.Model;
                userModel.fetchEx({},{
                    url : 'api/school/remove/'+$(e.currentTarget).attr("sid"),
                    success: function (data) {
